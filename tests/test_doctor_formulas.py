...
def test_doctor_formula_crud_and_approval_gate(tmp_path: Path) -> None:
    ...
    formula_id = formulas.create_doctor_formula(
        {"code": "KN001", "name": "Bài thuốc kinh nghiệm",
         "created_by": "BS Nguyễn", "ingredients_text": "Cam thảo — 4 g",
         "indications": "Mệt mỏi", "doctor_approved": False}
    )
    ...
    formulas.update_doctor_formula(
        formula_id,
        {"code": "KN001", "name": "Bài thuốc kinh nghiệm",
         "created_by": "BS Nguyễn", "ingredients_text": "Cam thảo — 6 g",
         "indications": "Mệt mỏi", "doctor_approved": True},
    )
